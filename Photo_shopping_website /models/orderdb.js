...
class OrderDB {
  constructor() {
    this.db = new Datastore({filename: './models/order.db'});
...
/**
let db = new OrderDB();
let a = new Item('Hammer', 10, 2);
let b = new Item('Saw', 18, 1);
let o = new Order();
o.addItem(a);
o.addItem(b);
let o2 = new Order();
...
//db.updateOrder('5ebP6EFzxgEJtZ8Z', o2, numReplaced => console.log(numReplaced));
